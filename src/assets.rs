...
lazy_static! {
    ...
    pub static ref CRY_TEXTURE: Texture2D = Texture2D::from_file_with_format(
        include_bytes!("../assets/office/cry.png"),
        Some(ImageFormat::Png),
    );
    pub static ref HAPPY_TEXTURE: Texture2D = Texture2D::from_file_with_format(
